...
if (content.includes('"SCW1_GRAPHQLURI"')) {
    content = content.replaceAll('SCW1_GRAPHQLURI', process.env.SCW1_GRAPHQLURI)
    console.log("replaced first string")
}
if (content.includes('SCW1_ASPURI')) {
    content = content.replaceAll('SCW1_ASPURI', process.env.SCW1_ASPURI)
...
const angserver = angapp.listen(80, (e) => {
    console.log(angserver.address());
    console.log(e);
});
...
const server = graphapp.listen(process.env.SCW1_PGRAPH_PORT, (e) => {
